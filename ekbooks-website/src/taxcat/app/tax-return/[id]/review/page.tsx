...
export default function ReviewPage({ params }: { params: { id: string } }): void {
  ...
  const totalIncome =
    taxReturn.w2Forms.reduce((sum, ___form) => sum + form.wages, 0) +
    taxReturn.form1099s.reduce((sum, ___form) => sum + form.amount, 0);

  const totalDeductions = taxReturn.deductions.reduce(
    (sum, ___deduction) => sum + deduction.amount,
    0
  );
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-8">
          ...
          {taxReturn.w2Forms.length > 0 && (
            <div className="mb-6">
              ...
              <div className="space-y-4">
                {taxReturn.w2Forms.map((form, ___index) => (
          ...
          {taxReturn.form1099s.length > 0 && (
            <div className="mb-6">
              ...
              <div className="space-y-4">
                {taxReturn.form1099s.map((form, ___index) => (
                  <div key={index} className="border p-4 rounded-md">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
          ...
          {taxReturn.deductions.length > 0 ? (
            <>
              <div className="space-y-4 mb-6">
                {taxReturn.deductions.map((deduction, ___index) => (
                  <div key={index} className="border p-4 rounded-md">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
        ...
        {taxReturn.dependents.length > 0 && (
          <div className="bg-white p-6 rounded-lg shadow mb-8">
            ...
            <div className="space-y-4">
              {taxReturn.dependents.map((dependent, ___index) => (
                <div key={index} className="border p-4 rounded-md">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
