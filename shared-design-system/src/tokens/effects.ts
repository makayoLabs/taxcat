 ...
 * Shadows, borders, transitions, and animations
 * Based on Wealthsimple's design system
 */

export const effects = {
  // Box shadows (Wealthsimple style - subtle and refined)
  boxShadow: {
    none: 'none',
    ...
    'primary-lg': '0 8px 20px rgba(0, 169, 80, 0.4)',
  },

  // Border radius (Wealthsimple uses generous rounded corners)
  borderRadius: {
    none: '0',
    sm: '0.25rem',    // 4px
    DEFAULT: '0.5rem', // 8px
