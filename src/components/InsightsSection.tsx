  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Stay on top of important tax deadlines this year and avoid costly penalties. We break down all the key dates for personal and business tax filings.',
    ...
    },
    {
      ...
      excerpt:
        'Discover often-overlooked business expenses that could significantly reduce your tax burden. From home office costs to professional development.',
    ...
    },
    {
      ...
      excerpt:
        'Essential tax tips for freelancers and independent contractors. Learn about quarterly payments, expense tracking, and avoiding common mistakes.',
      category: 'Freelance',
      image:
    ...
    },
    {
      ...
      excerpt:
        'How to structure your retirement savings to minimize tax impact. RRSPs, TFSAs, and other tax-advantaged accounts explained.',
      category: 'Personal',
      image:
      ...
      <div className="container-max">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-text-light max-w-3xl mx-auto">
            Stay informed with our latest tax advice, insights, and strategies to help you file
            smarter and save more money.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-12">
          {blogPosts.map((___post) => (
            <BlogCard key={___post.id} post={___post} />
          ))}
        </div>
        ...
        <div className="mt-16 bg-gradient-to-br from-primary-navy to-primary-blue rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Get the latest tax tips, deadlines, and insights delivered straight to your inbox. Join
            thousands of Canadians who trust TaxCat for their tax advice.
          </p>
