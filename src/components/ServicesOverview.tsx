...
const ServicesOverview = () => {
  return (
    <section id="services" className="section-padding bg-gradient-to-br from-primary-navy/5 to-primary-blue/5">
      <div className="container-max">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-text-light max-w-3xl mx-auto">
            Whether you're an individual taxpayer or running a small business, 
            we have the expertise to maximize your returns and minimize your stress.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="card p-8 group hover:shadow-xl">
            <div className="text-center mb-8">
              ...
              <p className="text-text-light mb-6">
                Complete individual tax filing services with expert guidance to ensure 
                you get every deduction and credit you deserve.
              </p>
            </div>
          ...
          <div className="card p-8 group hover:shadow-xl">
            <div className="text-center mb-8">
              ...
              <p className="text-text-light mb-6">
                Comprehensive business tax services including bookkeeping, 
                quarterly filings, and strategic tax planning for growth.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          <div className="text-center p-6 rounded-lg bg-white/50">
            ...
            <p className="text-sm text-text-light">Strategic advice to minimize future tax liability</p>
          </div>
          <div className="text-center p-6 rounded-lg bg-white/50">
            <div className="text-4xl mb-4">🔍</div>
            <h4 className="font-semibold text-text-dark mb-2">Audit Support</h4>
            <p className="text-sm text-text-light">Professional representation if you face an audit</p>
          </div>
          <div className="text-center p-6 rounded-lg bg-white/50">
            <div className="text-4xl mb-4">💼</div>
            <h4 className="font-semibold text-text-dark mb-2">Business Setup</h4>
            <p className="text-sm text-text-light">Help incorporating and setting up your business structure</p>
          </div>
        </div>
      </div>
    </section>
