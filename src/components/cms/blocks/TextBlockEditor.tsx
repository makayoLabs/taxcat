...
const TextBlockEditor = ({ content, onUpdate }: TextBlockEditorProps) => {
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => handleChange('fontSize', e.target.value as 'small' | 'medium' | 'large' | 'xl')}
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => handleChange('fontWeight', e.target.value as 'normal' | 'semibold' | 'bold')}
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
          >
